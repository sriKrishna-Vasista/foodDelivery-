...
public class IndexController {
	...
	public ModelAndView home() {
		...
		modelAndView.addObject("cities", addressService.findAll());
	...
	@GetMapping("/show/city/{city}/products")
	public ModelAndView showProductsByCity(@PathVariable("city") String city) {
		ModelAndView modelAndView = new ModelAndView("page");
